            ...
            <div className="sm:col-span-4 col-span-4">
              ...
              <div className="mt-2">
                <input
                  ...
                  value={userInfo.name}
                  autoComplete="name"
                  className="block w-full rounded-md border-0 py-1.5 text-gray-900 pl-2.5 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6"
                />
              </div>
            </div>
            ...
            <div className="sm:col-span-4 col-span-4">
              ...
              <div className="flex rounded-md shadow-sm ring-1 ring-inset ring-gray-300 focus-within:ring-2 focus-within:ring-inset focus-within:ring-indigo-600 ">
                <input
                  ...
                  autoComplete="phone"
                  className="block flex-1 border-0 bg-transparent pl-2.5 py-1.5 pl-1 text-gray-900 placeholder:text-gray-400 focus:ring-0 sm:text-sm sm:leading-6"
                />
              </div>
            </div>
